  ...
  return (<>
    ...
    <div className="main">
      <div className="main__text-wrapper">
        <p className="main__title">Discover Your Perfect Match with <span>RêveDate</span> – "Where Connections Flourish!"</p>
        <div className="btn-container">
          <a className="btn-content" href="/signup">
